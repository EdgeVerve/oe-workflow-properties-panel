 ...
 * @return {ModdleElement} the connector object
 */
InputOutputHelper.getEVFConnector = function(element) {
  var bo = implementationTypeHelper.getEVFServiceTaskLikeBusinessObject(element);
 // console.log(bo);
  return bo && (getElements(bo, 'camunda:EVFConnector')|| [])[0];  
};
 ...
 * @return {ModdleElement} the connector object
 */
InputOutputHelper.getFTConnector = function(element) {
  var bo = implementationTypeHelper.getFTServiceTaskLikeBusinessObject(element);
 // console.log(bo);
  return bo && (getElements(bo, 'camunda:FinalizeTransactionConnector')|| [])[0];  
};
