 ...
 * @return {ModdleElement} the connector object
 */
InputOutputHelper.getOEConnector = function(element) {
  var bo = implementationTypeHelper.getOEServiceTaskLikeBusinessObject(element);
 // console.log(bo);
  return bo && (getElements(bo, 'camunda:oeConnector')|| [])[0];  
};
