...
ImplementationTypeHelper.isOEServiceTaskLike = function(element) {
  return is(element, 'camunda:ServiceTaskLike');
};
 ...
 * @return {ModdleElement} the 'camunda:ServiceTaskLike' business object
 */
ImplementationTypeHelper.getOEServiceTaskLikeBusinessObject = function(element) {
  ...
  return this.isOEServiceTaskLike(element) && getBusinessObject(element);
...
//  //   console.log(connectors) && connectors[0].ModdleElement.$type==='camunda:OEConnector
//     if (typeof connectors !== 'undefined') {
//       return 'connector';
//     }else {
//       connectors = extensionsElementHelper.getExtensionElements(bo, 'camunda:OEConnector');
//       if (typeof connectors !== 'undefined') {
//       return 'oeconnector';
//     }
//     }
...
var bo = this.getOEServiceTaskLikeBusinessObject(element);
  if (this.isOEServiceTaskLike(bo)) {
    var connectors = extensionsElementHelper.getExtensionElements(bo, 'camunda:oeConnector');
    if (typeof connectors !== 'undefined') {
     // console.log("oeconnector")
