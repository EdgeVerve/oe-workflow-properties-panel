  ...
  entries.push(entryFactory.selectBox({
    ...
    set: function (element, values, node) {
      ...
      if (hasServiceTaskLikeSupport && newType === 'connector') {
        ...
        var tempConnectors = extensionElementsHelper.getExtensionElements(bo, 'camunda:oeConnector');
      ...
      if (hasEVServiceTaskLikeSupport && newType === 'oeconnector') {
        commands = [];
        commands.push(cmdHelper.updateBusinessObject(element, bo, props));
        var connectors = extensionElementsHelper.getExtensionElements(bo, 'camunda:oeConnector');
        ...
        if (newType === 'oeconnector') {
          ...
          var connector = elementHelper.createElement('camunda:oeConnector', {}, extensionElements, bpmnFactory);
          commands.push(cmdHelper.addAndRemoveElementsFromList(
            element,
            extensionElements,
            'values',
      ...
      if (hasFTServiceTaskLikeSupport && newType === 'finalizetransactionconnector') {
        ...
        var tempConnectors = extensionElementsHelper.getExtensionElements(bo, 'camunda:Connector');
        var temp1Connectors = extensionElementsHelper.getExtensionElements(bo, 'camunda:oeConnector');
