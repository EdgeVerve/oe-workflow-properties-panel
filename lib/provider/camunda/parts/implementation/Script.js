...
return {
  template:
    '<div class="style-scope work-flow pp-row pp-textfield">' +
      '<label for="cam-script-format">Script Format</label>' +
      '<div class="style-scope work-flow pp-field-wrapper">' +
        '<input id="cam-script-format" type="text" class="style-scope work-flow" name="scriptFormat" disabled="disabled" value="javascript"  />' + //give default to JS
    ...
    '<div class="pp-row">' +
      ...
      '<div class="style-scope work-flow pp-field-wrapper">' +
        '<select id="cam-script-type" disabled="disabled" class="style-scope work-flow" name="scriptType" data-value >' +
    ...
    '<div class="pp-row pp-textfield">' +
      ...
      '<div class="style-scope work-flow pp-field-wrapper" data-show="script.isScriptResource">' +
        '<input id="cam-script-resource-val" type="text" class="style-scope work-flow" name="scriptResourceValue" />' +
        '<button class="style-scope work-flow clear" data-action="script.clearScriptResource" data-show="script.canClearScriptResource">' +
          '<span>X</span>' +
        '</button>' +
      '</div>' +
    '</div>' +
    ...
    '<div class="pp-row">' +
      ...
      '<div class="style-scope work-flow pp-field-wrapper" data-show="script.isScript">' +
        '<textarea id="cam-script-val" class="style-scope work-flow materialize-textarea" onkeyup="textAreaAdjust(this)"  type="text" name="scriptValue"></textarea>' +
      '</div>'+
    '</div>',
    ...
    get: function (element, bo) {
      ...
      values.scriptFormat = 'javscript';//boScriptFormat;
    ...
    set: function(element, values, containerElement) {
      ...
      if (isFormatRequired) {
        // always set language
        update[scriptLanguagePropName] = scriptFormat || 'javascript';
      } else
    ...
    clearScriptFormat: function(element, inputNode, btnNode, scopeNode) {
      domQuery('input[name=scriptFormat]', scopeNode).value='javascript';
