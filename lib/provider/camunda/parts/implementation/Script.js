  ...
  template:
    '<div class="pp-row pp-textfield">' +
      ...
      '<div class="pp-field-wrapper">' +
        '<input id="cam-script-format" type="text" name="scriptFormat" disabled="disabled" value="javascript"  />' + //give default to JS
    ...
    '<div class="pp-row">' +
      ...
      '<div class="pp-field-wrapper">' +
        '<select id="cam-script-type" disabled="disabled" name="scriptType" data-value >' +
    ...
    '<div class="pp-row">' +
      ...
      '<div class="pp-field-wrapper" data-show="script.isScript">' +
        '<textarea id="cam-script-val" onkeyup="textAreaAdjust(this)"  type="text" name="scriptValue"></textarea>' +
      '</div>'+
    '</div>',
