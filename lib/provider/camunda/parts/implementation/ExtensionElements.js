...
module.exports = function (element, bpmnFactory, options) {
  ...
  return {
    id: id,
    html: '<div class="style-scope work-flow pp-row pp-element-list" ' +
            ...
            '<div class="style-scope work-flow pp-field-wrapper">' +
              ...
              '</select>' +
              (canCreate ? '<button class="style-scope work-flow add" ' +
                                   'id="cam-extensionElements-create-' + id + '" ' +
                                   'data-action="createElement">' +
                             '<span>+</span>' +
                           '</button>' : '') +
              (canRemove ? '<button class="style-scope work-flow clear" ' +
