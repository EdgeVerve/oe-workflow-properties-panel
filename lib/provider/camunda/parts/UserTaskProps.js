...
module.exports = function(group, element) {
  ...
  /*  group.entries.push(entryFactory.textField({
    ...
    //Maker/Auto Finalize/ Basic Task
    group.entries.push(entryFactory.selectBox({
      id : 'taskCategory',
      description : 'Kind of User Task',
      label : 'Task Category',
      selectOptions: [ { name: 'Basic Task', value: 'basic' }, { name: 'Multi Maker', value: 'multiMaker' }, { name: 'Auto Finalize', value: 'autoFinalize' } ],
      modelProperty : 'taskCategory'
    //   get: function(element, node) {
    //     var attr = getAttribute(element, 'element');
    //     if (attr) {
    //       var bo = getBusinessObject(element);
    //       taskCategory = bo.get(attr);
    //     }
    //     return {
