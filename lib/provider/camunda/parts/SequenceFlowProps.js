...
module.exports = function(group, element, bpmnFactory) {
  ...
  group.entries.push({
    ...
    label: 'Condition',
    html: '<div class="style-scope work-flow pp-row">' +
              '<label for="cam-condition-type">Condition Type </label>' +
              '<div class="style-scope work-flow pp-field-wrapper">' +
                '<select id="cam-condition-type" class="style-scope work-flow" name="conditionType" data-value>' +
            ...
            '<div class="pp-row">' +
              ...
              '<div class="style-scope work-flow pp-field-wrapper" data-show="isExpression">' +
                '<input id="cam-condition" class="style-scope work-flow" type="text" name="condition" />' +
                '<button class="style-scope work-flow clear" data-action="clear" data-show="canClear">' +
                  '<span>X</span>' +
                '</button>' +
              '</div>' +
