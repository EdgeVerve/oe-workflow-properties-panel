  ...
  group.entries.push({
    ...
    html: '<div class="style-scope work-flow pp-row">' +
            ...
            '<div class="style-scope work-flow pp-field-wrapper">' +
              '<select id="camunda-formType" class="style-scope work-flow" name="formType" data-value>' +
                '<option class="style-scope work-flow" value="form-key">Form Key</option>' +
                '<option class="style-scope work-flow" value="form-data">Form Data</option>' +
              '</select>' +
            '</div>' +
          '</div>',
    get: function(element, node) {
