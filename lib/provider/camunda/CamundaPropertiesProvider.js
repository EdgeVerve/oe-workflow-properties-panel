...
var OEConnectorDetails = require('./parts/OEConnectorDetailProps');
...
function createOEConnectorTabGroups(element, bpmnFactory, elementRegistry) {
  var OEconnectorDetailsGroup = {
    id: 'oeconnector-details',
    label: 'Details',
    entries: []
  };
  OEConnectorDetails(OEconnectorDetailsGroup, element, bpmnFactory);
  return [
    OEconnectorDetailsGroup
  ];
}
...
function CamundaPropertiesProvider(eventBus, bpmnFactory, elementRegistry, elementTemplates) {
  ...
  this.getTabs = function (element) {
    ...
    var oeconnectorTab = {
      id: 'oeconnector',
      label: 'OE Connector',
      groups: createOEConnectorTabGroups(element, bpmnFactory, elementRegistry),
      enabled: function (element) {
        var bo = implementationTypeHelper.getServiceTaskLikeBusinessObject(element);
