...
var comboBox = function(options) {
  ...
  comboBoxEntry.html += '<div class="pp-field-wrapper input-field pp-combo-input style-scope work-flow" ' +
    'data-show="showCustomInput"' +
    '>' +
    '<input id="camunda-' + options.id + '-input" class="style-scope work-flow" type="text" name="custom-' + modelProperty+'" ' +
      ' />' +
  '</div>';
